...
<div class="a4-container" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt; padding: 40px;">
    ...
    <div style="text-align: center;">
        <u><strong style="font-size: 14pt;">SURAT KETERANGAN PENGHASILAN ORANG TUA/strong></u><br>
        <span>Nomor: 145 / 0<?= $id; ?> / V.01.17 / 2025</span>
    </div>

    <br>

    <p style="font-size: 12pt;">Yang bertanda tangan di bawah ini, Kepala Desa Bogorejo Kecamatan Gedong Tataan Kabupaten Pesawaran, memberikan keterangan ini kepada:</p>
    ...
    <p style="font-size: 12pt;">Nama tersebut diatas adalah anak kandung dari:</p>
    ...
    <p style="font-size: 12pt; margin: 0;">Adalah benar nama tersebut di atas Warga Desa Bogorejo, Kecamatan Gedong Tataan, Kabupaten Pesawaran dengan tanggungan keluarga sebanyak</p>
