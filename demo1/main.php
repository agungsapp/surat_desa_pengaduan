		...
		<div class="main-panel">
          ...
          if(isset($_GET['halaman'])){
            ...
            switch($hal){
			  ...
			  break;
			  case 'view_cetak_user':
				include 'view_cetak_user.php';
				break;
				case 'view_cetak_sku_user':
					include 'view_cetak_sku_user.php';
					break;
					case 'view_cetak_skd_user':
						include 'view_cetak_skd_user.php';
						break;
						case 'view_cetak_skp_user':
							include 'view_cetak_skp_user.php';
							break;
			  case 'tampil_user';
              ...
              break;
			  case 'cetak_surat_user';
			  include 'cetak_surat_user.php';
			break;
			case 'home';
			include 'home.php';
		  break;
