...
include '../phpqrcode/qrlib.php';
    ...
    $link_verifikasi = "http://localhost/surat_keterangan_desa/verifikasi_surat.php?jenis=skp&id=$id";
        $nama_file_qr = "../phpqrcode/skp_qr_$id.png";
...
<script src="js/sweetalert.min.js"></script> 
 <div class="panel-header bg-primary-gradient">
    ...
    <a href="cetak_skp.php?id_request_skp=<?= $id ?>" target="_blank" class="btn btn-success btn-sm">
...
<div class="a4-container" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt; padding: 40px;">
    ...
    <table style="margin-left: 20px;">
    <tr><td width="180px">Nama Usaha</td><td>: <?= ucwords ($nama_usaha);?></td></td></tr>
        <tr><td>Jenis Usaha</td><td>: <?= $jenis_usaha;?></td></td></tr>
...
<br><p style="font-size: 12pt; margin: 0;">Demikian Surat Keterangan ini disampaikan, agar dipergunakan sebagaimana mestinya</p>
    ...
    <tr>
        ...
        <td style="float: right; text-align: left; padding-right: 30px;"> <!-- Memberi jarak ke kanan dengan padding -->
            ...
            <img src="../phpqrcode/skp_qr_<?= $id; ?>.png" width="80" height="80"><br>
            <u><b>(HERMANSYAH)</b></u>
        </td>
