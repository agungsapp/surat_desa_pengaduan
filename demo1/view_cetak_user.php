								    ...
								    <div class="card-tools">
                                        <form action="" method="POST">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
    <a href="cetak_sktm.php?id_request_sktm=<?= $data['id_request_sktm'] ?>" target="_blank" class="btn btn-success btn-sm">
...
<div class="a4-container" style="font-family: 'Times New Roman', Times, serif; font-size: 12pt; padding: 40px;">
    ...
    <div style="text-align: center;">
        <u><strong style="font-size: 14pt;">SURAT KETERANGAN TIDAK MAMPU</strong></u><br>
