							...
							<div class="col-md-7">
								<div class="card">
									<div class="card-header">
												...
												<a href="??halaman=permohonan_surat" class="btn btn-info btn-border btn-round btn-sm">
													Batal
												</a>
												</div>
									</div>
									<div class="card-body">
										...
										<div class="col-md-6 col-lg-6">
												...
												<div class="col-md-6 col-lg-6">
													...
													<div class="form-group">
														<label for="comment">Alamat Domisili</label>
													...
													<div class="form-group">
														<label>Alamat</label>
														<input type="text" name="alamat" class="form-control" placeholder="Keperluan Anda.." value="<?=$keperluan;?>">
													</div>
												</div>
										</div>
									</div>
