											...
											<div class="col-md-6 col-lg-6">
												...
												<div class="form-group">
													...
													<select name="status_warga" class="form-control">
														...
														<option value="Belum/Tidak Bekerja" <?php if($status_warga=="Belum/Tidak Bekerja") echo 'selected'?>>Belum/Tidak Bekerja</option>
													</select>
												</div>
												<div class="form-group">
...
if(isset($_POST['simpan'])){
	...
	$sql = "INSERT INTO data_user (nik,password,hak_akses,nama,jekel,tempat_lahir,tanggal_lahir,status_warga,kawin,alamat) VALUES ('$nik','$password','$hak_akses','$nama','$jekel','$tempat','$tanggal','$status_warga','$kawin','$alamat')";
