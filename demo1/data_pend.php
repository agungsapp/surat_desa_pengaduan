<?php
include('/xampp/htdocs/surat_keterangan_desa/koneksi/konek3.php'); 
?>
		...
		<div class="table-responsive">
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<?php
              $no = 1;
			  $sql = $konek3->query("SELECT p.id_pend, p.nik, p.nama, p.nm_ayah_pdd, p.nm_ibu_pdd, p.jekel, p.desa, p.rt, p.rw, a.id_kk, k.no_kk, k.kepala from 
